...
public class EtudiantRestService {
    ...
    //permet de savoir l'identité de l'utiisateur authentifier
    public Map<String, Object> getLogedUser(HttpServletRequest httpServletRequest) {
        ...
        //permet de récupérer tous les roles de l'utilisateur
        for (GrantedAuthority ga : securityContext.getAuthentication().
                getAuthorities()) {
